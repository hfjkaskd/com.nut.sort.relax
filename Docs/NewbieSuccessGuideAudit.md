...
Correction: ARM64 class layout places the vtable at 0x138, not 0x128. The original visual target remains MoreGetBtn, while the invoked operation is GetCallback. The earlier slot-12 interpretation was incorrect.
