...
This is controller composition evidence with explicit fixture clock/random/UI callbacks. No SDK event or real withdrawal is simulated. PlayProgressTween1 0x9cf7d0, PlayProgress 0x9cfda8 and the IsShowOnlineTimeHint animation branch still require native animation/view recovery. The current source TXProgress0Panel prefab is available, but no new visual screenshot or production page claim is made here. Full startup, country/AB routing and the complete 1:1 lifecycle remain unfinished.
