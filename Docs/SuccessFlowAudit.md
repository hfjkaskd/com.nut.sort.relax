...
Follow-up: the response router's subround rebuild and level-six coin-new-player gate are restored in SuccessResponseAudit.md. Settlement payload construction and real panel/transport composition remain pending.
