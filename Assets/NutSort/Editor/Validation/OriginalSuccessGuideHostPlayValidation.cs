...
namespace NutSort.Validation
{
    ...
    public static class OriginalSuccessGuideHostPlayValidation
    {
        ...
        private static int phase,targets,ads,requests;
        ...
        {
            public bool HasPanel=>success.IsOpen||guide.IsOpen;
            ...
            public void ShowTargetPanel(int id,int level){Check(id==35&&level==1&&!guide.IsOpen,"Reopened guide advances to target completion after close");targets++;}
        ...
        private static void Tick()
        {
            ...
            try
            {
                ...
                if(phase==0)
                {
                    ...
                    var ui=new OriginalSceneGuideUI(game,()=>null,mask,panels,null);
                ...
                Check(!masked&&ads==0&&requests==0,"Original mask releases independently; no SDK request or reward fabricated");
                Debug.Log("NUT_SUCCESS_GUIDE_HOST_PLAY_PASS real SuccessPanel opening -> real guide host -> actual target binding/direct GetCallback -> success close -> counted mask -> delayed guide reopen -> target-panel branch; target panel/request consumers remain explicit fixtures.");Finish(0);
            }
