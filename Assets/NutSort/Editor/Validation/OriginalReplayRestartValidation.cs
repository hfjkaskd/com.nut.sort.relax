...
namespace NutSort.Validation
{
    public static class OriginalReplayRestartValidation
    {
        public static void Validate()
        {
            ...
            Debug.Log("NUT_REPLAY_RESTART_VALIDATION_PASS actual scene repeated reset/rebuild delay, unchanged seed/stage/failure/cumulative moves, short entry and no early save.");
        }
