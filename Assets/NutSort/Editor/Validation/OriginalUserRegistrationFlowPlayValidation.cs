...
namespace NutSort.Validation
{
    ...
    public static class OriginalUserRegistrationFlowPlayValidation
    {
        ...
        private static Action<string,byte[]> registered;private static Action<JObject> reward;private static readonly List<Action<string,byte[]>> configs=new List<Action<string,byte[]>>();
