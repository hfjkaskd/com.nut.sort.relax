    ...
    public static class OriginalContentValidation
    {
        ...
        public static void Run()
        {
            try
            {
                ...
                OriginalWithdrawalUserInfoPanelValidation.Validate();
                OriginalWithdrawalConfirmationValidation.Validate();
                OriginalWithdrawalConfirmationPanelValidation.Validate();
                OriginalGoldGetValidation.Validate();
                OriginalWithdrawalLevelValidation.Validate();
                OriginalWithdrawalLevelPanelValidation.Validate();
                OriginalWithdrawalChannelValidation.Validate();
                OriginalWithdrawalSuccessValidation.Validate();
                OriginalWithdrawalProgressFlowValidation.Validate();
                OriginalWithdrawalStageZeroValidation.Validate();
                ...
                OriginalWithdrawalStageZeroPanelValidation.Validate();
                ...
                OriginalUserSessionStartupValidation.Validate();
                OriginalBootstrapValidation.Validate();
                OriginalBootLoadingValidation.Validate();
                OriginalBootLoadingPanelValidation.Validate();
                ...
                OriginalGoldRewardInfoFlowValidation.Validate();
