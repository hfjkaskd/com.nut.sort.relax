...
namespace NutSort.Validation
{
    public static class OriginalScrewTypeRefreshValidation
    {
        ...
        public static void Validate(OriginalLevelRepository repository)
        {
            ...
            Debug.Log("NUT_SCREW_TYPE_REFRESH_VALIDATION_PASS ordered mask/unmovable/adjacent-hidden transitions, first-type admission, multiple entries, per-entry saves, original mask scale and independent hide timings; native cover clip conversion has separate validation.");
        }
